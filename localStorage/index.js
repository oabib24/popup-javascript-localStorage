...
function initializePopups() {
        ...
        popups.forEach(function(popup) {
            ...
            if (lastClosedAt + hideDuration * 3600 * 1000 > (new Date()).getTime()){
                console.log("Should not show until the specific time.")
            }
            else{
                ...
                // console.log(delay);
                // console.log(scrollTriggerPercentage)
                ...
                console.log(popup.getAttribute('fitr-popr-exit-intent') !==null)

                // Initialize exit intent (if applicable)
                if (popup.getAttribute('fitr-popr-exit-intent') !== null) {
                    console.log(popup.getAttribute('fitr-popr-exit-intent'))
